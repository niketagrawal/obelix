"""
This tests compares the descriptor values generated by OBeLiX for different metal adducts and output types with the expected descriptor values for the same set of files. The expected descriptor values are stored in a csv file in the expected_output folder.
